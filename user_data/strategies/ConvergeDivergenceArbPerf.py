    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        for no_of_candles_to_con_div in range(self.no_of_candles_to_con_div_min,self.no_of_candles_to_con_div_max):
            ...
            if no_of_candles_to_con_div == self.no_of_candles_to_con_div_min:
                dataframe.loc[
                    dataframe['buy' + '_' + str(no_of_candles_to_con_div)] == 1, 'buy_tag'] = '_len' + '_' + str(
                    no_of_candles_to_con_div);
            else:
                dataframe.loc[dataframe['buy' + '_' + str(no_of_candles_to_con_div)] == 1, 'buy_tag'] = dataframe[
                                                                                                            'buy_tag'] + '_len' + '_' + str(
                    no_of_candles_to_con_div);

            list_of_columns_to_be_dropped = ['old_rsi' + '_' + str(no_of_candles_to_con_div),
                                             'rsi_mov' + '_' + str(no_of_candles_to_con_div),
                                             'top' + '_' + str(no_of_candles_to_con_div),
                                             ...
                                             'moun_line_cross' + '_' + str(no_of_candles_to_con_div),
                                             'mount_max' + '_' + str(no_of_candles_to_con_div),
